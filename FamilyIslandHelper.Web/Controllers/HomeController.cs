	...
	public class HomeController : Controller
	{
		...
		public IActionResult Index()
		{
			...
			viewModel = new ViewModel
			{
				...
				ComponentsTreeHtml = ItemInfoService.GetComponentsTree(apiVersion,item1, showListOfComponents)
			};
		...
		public IActionResult Index(ViewModel viewModel)
		{
			...
			viewModel.ComponentsTreeHtml = ItemInfoService.GetComponentsTree(apiVersion, item, viewModel.ShowListOfComponents);
