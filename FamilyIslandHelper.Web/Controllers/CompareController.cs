	...
	public class CompareController : Controller
	{
		...
		public IActionResult Index()
		{
			...
			compareViewModel = new CompareViewModel
			{
				...
				ComponentsTreeHtml1 = ItemInfoService.GetComponentsTree(apiVersion, item1, showListOfComponents),
				Items2 = items2,
				ItemName2 = itemName2,
				...
				ComponentsTreeHtml2 = ItemInfoService.GetComponentsTree(apiVersion, item2, showListOfComponents),
		...
		public IActionResult Index(CompareViewModel compareViewModel)
		{
			...
			compareViewModel.ComponentsTreeHtml1 = ItemInfoService.GetComponentsTree(apiVersion, item1, compareViewModel.ShowListOfComponentsForAll);
			compareViewModel.ComponentsTreeHtml2 = ItemInfoService.GetComponentsTree(apiVersion, item2, compareViewModel.ShowListOfComponentsForAll);
